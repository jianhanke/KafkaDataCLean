...
object Sgmw {
  ...
  def isRetainGgmw(old_obj: JSONObject, new_obj: JSONObject): Boolean ={
    ...
    var isReatain = true;
    val totalCurrent:Integer = new_obj.getInteger("totalCurrent")
...
//    val insulationResistance: Integer = new_obj.getInteger("insulationResistance") //单位为千欧
...
//    }
    ...
    new_obj.put("current",totalCurrent*100 - 1000000) //换算成真实电流值
    isReatain
  }
